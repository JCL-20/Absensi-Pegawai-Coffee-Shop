...
<head>
    ...
    <title>Absensi Foresthree Coffee</title>
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="../assets/img/sidebar-5.jpg" data-color="style=">
            <!--
        ...
        <div class="main-panel">
            <!-- Navbar -->
            <nav class="navbar navbar-expand-lg bg-main " color-on-scroll="500">
                <div class=" container-fluid">
                    <a class="navbar-brand text-white" href="#pablo"> Absensi </a>
